...
data<-readRDS("DATA/training_data/refined_traindata_03192021.rds")%>%
  drop_na()
...
saveRDS(caret_fit_base, "model_runs/refined_traindata_03192021_no_height/model_03192021.rds")
