...
saveRDS(final_data, "DATA/training_data/training_polygons12N_03172020_UPDATE_OTHER_VEG_scale_NONE_data_03282020_new.rds")
```
...
set.seed(1234)
options(scipen=999)
data<-readRDS("DATA/training_data/training_polygons12N_03172020_UPDATE_OTHER_VEG_scale_NONE_data_03282020_new.rds")%>%
  drop_na()%>%
...
saveRDS(caret_fit_base, "model_runs/training_polygons12N_03172020_UPDATE_OTHER_VEG_scale_NONE_data_03282020_new/training_polygons12N_03172020_UPDATE_OTHER_VEG_scale_NONE_data_03282020_new_new.rds")
